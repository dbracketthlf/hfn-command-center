...
export function normalizeArivePayload(payload, receivedAt) {
  ...
  const milestoneDates={initialLESentDate:value(payload,'keyDates_initialLESentDate'),initialLESignedDate:value(payload,'keyDates_initialLESignedDate'),intentToProceedDate:value(payload,'keyDates_intentToProceedDate'),initialCDSentDate:value(payload,'keyDates_initialCDSentDate'),mostRecentCDSentDate:value(payload,'keyDates_mostRecentCDSentDate'),appraisalOrderedDate:value(payload,'keyDates_appraisalOrderedDate'),hoiOrderedDate:value(payload,'keyDates_hoiOrderedDate'),titleOrderedDate:value(payload,'keyDates_titleOrderedDate'),payoffOrderedDate:value(payload,'keyDates_payoffOrderedDate','payoffOrderedDate'),appraisalReceivedDate:value(payload,'keyDates_appraisalReceivedDate','appraisalReceivedDate'),hoiReceivedDate:value(payload,'keyDates_hoiReceivedDate','hoiReceivedDate'),titleReceivedDate:value(payload,'keyDates_titleReceivedDate','titleReceivedDate'),payoffReceivedDate:value(payload,'keyDates_payoffReceivedDate','payoffReceivedDate')};
