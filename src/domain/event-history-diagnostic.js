...
const requestShape=event=>Object.hasOwn(event,'incomingFieldPresence')?{
  ...
  recognizedTrackerFieldLocations:event.recognizedTrackerFieldLocations??null
}:{incomingFieldPresence:historicalUnavailable,topLevelKeys:historicalUnavailable,payloadStructure:historicalUnavailable,recognizedTrackerFieldLocations:historicalUnavailable};
