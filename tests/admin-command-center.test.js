...
import { buildAdminCommandCenter, buildClosingOutlook, buildMorningCommandBrief, buildPipelineWaitingSummary, capacityForEmployee, capacityThresholds } from '../src/domain/admin-command-center.js';
